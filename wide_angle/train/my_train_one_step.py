...
DATFILE_TYPE = 'wide_angle'
FILENAME_CSV_TRAIN = os.path.join(os.path.abspath('..'),
              'datafiles', DATFILE_TYPE, 'split_patid_train_v2.csv')
FILENAME_CSV_VALID = os.path.join(os.path.abspath('..'),
              'datafiles', DATFILE_TYPE,  'split_patid_valid_v2.csv')
FILENAME_CSV_TEST = os.path.join(os.path.abspath('..'),
              'datafiles', DATFILE_TYPE,  'split_patid_test_v2.csv')
...
WEIGHT_CLASS_START = np.array([1.5, 1])
WEIGHT_CLASS_END = np.array([1.5, 1])
BALANCE_RATIO = 0.93
...
for i in range(TRAIN_TIMES):
    ...
    #for model_name in ['InceptionV3','Xception', 'InceptionResnetV2', 'mobilenet_v2', 'NASNetMobile']:
        ...
        DICT_LR_FINETUNING['4'] = 1e-4
        DICT_LR_FINETUNING['8'] = 3e-5
        DICT_LR_FINETUNING['12'] = 1e-5
        DICT_LR_FINETUNING['15'] = 3e-6
        DICT_LR_FINETUNING['17'] = 1e-6  # 0.000001
