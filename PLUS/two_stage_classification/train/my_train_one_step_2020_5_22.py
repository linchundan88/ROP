...
MODEL_SAVE_BASEDIR = os.path.join('/tmp5/models_2020_5_22/', TRAIN_TYPE)
...
WEIGHT_CLASS_START = np.array([1, 5])
WEIGHT_CLASS_END = np.array([1, 5])
BALANCE_RATIO = 0.93
...
for i in range(TRAIN_TIMES):
    for MODEL_NAME in ['InceptionResnetV2', 'InceptionV3']:
