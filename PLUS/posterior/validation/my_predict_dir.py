...
# dir_original = '/media/ubuntu/data1/ROP项目/plus_combine_dataset/original'
# dir_preprocess = '/media/ubuntu/data1/ROP项目/plus_combine_dataset/preprocess384'
# dir_dest = '/media/ubuntu/data1/ROP项目/plus_combine_dataset/posterior'

dir_original = '/media/ubuntu/data1/ROP项目/ROP训练图集总汇_20200513_nolabel/op_plus/add_posterior/original'
dir_preprocess = '/media/ubuntu/data1/ROP项目/ROP训练图集总汇_20200513_nolabel/op_plus/add_posterior/preprocess384'
dir_dest = '/media/ubuntu/data1/ROP项目/ROP训练图集总汇_20200513_nolabel/op_plus/add_posterior/posterior_results'
...
filename_csv = os.path.join(dir_dest, 'posterior_predict_dir.csv')
if GEN_CSV:
