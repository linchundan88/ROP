...
dict_mapping = {'后极部': 0, '偏离': 1, '偏离后极部': 1}
dir1 ='/media/ubuntu/data1/ROP_dataset/Posterior/original'

write_labels_to_db(dir1, dict_mapping=dict_mapping, db_field_name='is_posterior')
