...
with open(file_csv, 'w', newline='') as csvfile:
    ...
    dir_path = '/media/ubuntu/data1/公开数据集/BloodVesselsSegment/original/HRF/images'
    ...
    for dir_path, subpaths, files in os.walk(dir_path, False):
        for f in files:
            ...
            img_file_mask = img_file_source.replace('/images/', '/manual1/')
            img_file_mask = img_file_mask.replace('.jpg', '.tif')
            img_file_mask = img_file_mask.replace('.JPG', '.tif')
