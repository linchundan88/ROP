...
def f1score(y_true, y_pred):
    def recall(y_true, y_pred):
        ...
        Computes the recall, a metric for multi-label two_stage_classification of
    ...
    def precision(y_true, y_pred):
        ...
        Computes the precision, a metric for multi-label two_stage_classification of
...
# loss function used in multi-label two_stage_classification
...
def combined_bce_dice_loss(w_ce=1, w_dice=4):
    def get_loss(y_true, y_pred):

        loss_b = w_ce * keras.losses.binary_crossentropy(y_true, y_pred)
        loss_j = w_dice * dice_coef_loss(y_true, y_pred)
...
'''
# https://stackoverflow.com/questions/48485870/multi-label-two_stage_classification-with-class-weights-in-keras/48700950#48700950
...
# https://stackoverflow.com/questions/43390162/class-weights-in-binary-two_stage_classification-model-with-keras
