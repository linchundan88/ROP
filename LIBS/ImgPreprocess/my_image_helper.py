...
def resize_images_dir(source_dir, dest_dir, convert_image_to_square=False, image_size=299,
                      over_write=True):
...
def my_gen_img_tensor(files, image_shape=(299, 299, 3), imgaug_seq=None, imgaug_times=1):
