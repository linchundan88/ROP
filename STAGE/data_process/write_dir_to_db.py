...
# CREATE TABLE tb_multi_labels1 LIKE tb_multi_labels;
# INSERT INTO tb_multi_labels1 SELECT * FROM tb_multi_labels;
...
dict_mapping_stage = {'0': 0, '正常_无反光': 0, '正常_反光': 0, '分期病变对照': 0, '分期病变': 1, '1': 1}
dir1 ='/media/ubuntu/data1/ROP_dataset/Stage/original'
write_labels_to_db(dir1, dict_mapping=dict_mapping_stage, db_field_name='stage')

db = get_db_conn()
cursor = db.cursor()
sql_update = 'update tb_multi_labels set hemorrhage1=hemorrhg'
cursor.execute(sql_update)
db.commit()
db.close()

dir1 = '/tmp5/result_20200308_confusion_matrix_postmodification/stage'
write_labels_to_db(dir1, dict_mapping=dict_mapping_stage, db_field_name='stage1')


# dict_mapping_plus = {'0': 0, '正常': 0, '对照': 0, '1':1, 'PLUS对照': 0,  'PLUS': 1}
# dir1 ='/media/ubuntu/data1/ROP_dataset/Plus/2020_02_12/original'
# write_labels_to_db(dir1, dict_mapping=dict_mapping_plus, db_field_name='plus')
