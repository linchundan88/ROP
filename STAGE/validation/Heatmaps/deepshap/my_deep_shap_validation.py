    ...
    for predict_type_name in ['Stage_split_patid_train', 'Stage_split_patid_valid', 'Stage_split_patid_test']:
        ...
        for _, row in df.iterrows():
            ...
            if preprocess:
                ...
                img_input = LIBS.ImgPreprocess.my_image_helper.my_gen_img_tensor(img_preprocess, image_shape=image_shape)
            else:
                img_input = LIBS.ImgPreprocess.my_image_helper.my_gen_img_tensor(image_file, image_shape=image_shape)
