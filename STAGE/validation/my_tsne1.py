...
filename_csv = os.path.join(os.path.abspath('..'),
                'datafiles/dataset13', 'Stage_split_patid_test.csv')
...
# model_file = os.path.join(model_dir, 'InceptionResnetV2-008-0.982.hdf5')
# model_file = os.path.join(model_dir, 'Xception-010-0.981.hdf5')
# model_file = os.path.join(model_dir, 'InceptionV3-010-0.979.hdf5')
...
draw_tsne(X_tsne, labels, nb_classes=nb_classes, save_tsne_image=save_tsne_image,
 labels_text=['Non-Stage', 'Stage'], colors=['g', 'r'])
